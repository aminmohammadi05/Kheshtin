...
export class MoodBoardDataSource implements DataSource<UserMoodBoard> {
    ...
    loadMoodBoards( ) {
                //     this.store.pipe( select(getUserMoodBoardsPageLoaded()),
                //     tap((moodBoard) => {
                ...
                //               this.store.dispatch(new RefreshMoodBoardPageAuthRequest(
                //                 moodBoard.allSearches[0] &&
                //                 moodBoard.allSearches[0].searchBox ? 'filter=' + moodBoard.allSearches[0].searchBox : 'filter=',
                //                 moodBoard.allSearches[0] &&
                //                 moodBoard.allSearches[0].categoriesBoxNested &&
                //                 moodBoard.allSearches[0].categoriesBoxNested[0] ?
                //                 moodBoard.allSearches[0].categoriesBoxNested : [],
                //                 moodBoard.allSearches[0].pageQuery,
                //                 this.authService.getDecodedToken().nameid));
                //           } else {
                //               this.store.dispatch(new RefreshMoodBoardPageRequest(
                //                 moodBoard.allSearches[0] &&
                //                 moodBoard.allSearches[0].searchBox ? 'filter=' + moodBoard.allSearches[0].searchBox : 'filter=',
                //                 moodBoard.allSearches[0] &&
                //                 moodBoard.allSearches[0].categoriesBoxNested &&
