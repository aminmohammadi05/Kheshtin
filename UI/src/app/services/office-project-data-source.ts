...
export class OfficeProjectDataSource implements DataSource<OfficeProject> {
    ...
    loadOfficeProjects( ) {
                //     this.store.pipe( select(getOfficeProjectsPageLoaded()),
                //     tap((officeProject) => {
                ...
                //         } else if (officeProject.allSearches[0].pageQuery.totalItems !== 0){
                //               if (this.authService.loggedIn()) {
                //               this.store.dispatch(new RefreshOfficeProjectPageAuthRequest(
                //                 officeProject.allSearches[0] &&
                //                 officeProject.allSearches[0].searchBox ? 'filter=' + officeProject.allSearches[0].searchBox : 'filter=',
                //                 officeProject.allSearches[0] &&
                //                 officeProject.allSearches[0].designers &&
                //                 officeProject.allSearches[0].designers.length > 0 ? officeProject.allSearches[0].designers : [],
                //                 officeProject.allSearches[0] &&
                ...
                //           } else {
                //               this.store.dispatch(new RefreshOfficeProjectPageRequest(
                //                 officeProject.allSearches[0] &&
                //                 officeProject.allSearches[0].searchBox ? 'filter=' + officeProject.allSearches[0].searchBox : 'filter=',
                //                 officeProject.allSearches[0] &&
                //                 officeProject.allSearches[0].designers &&
    ...
    connect(collectionViewer: CollectionViewer): Observable<OfficeProject[]> {
